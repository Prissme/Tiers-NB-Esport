...
const tierStyles: Record<string, string> = {
  ...
  A: 'from-violet-400/40 via-amber-400/40 to-indigo-400/40 text-violet-200',
  B: 'from-cyan-400/30 via-sky-400/30 to-blue-400/30 text-cyan-100',
  C: 'from-amber-400/30 via-teal-400/30 to-green-400/30 text-amber-100',
...
export default function PlayerCard({ player, children }: PlayerCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 h-32 w-32 rounded-full bg-amber-400/20 blur-3xl" />

      <div className="relative flex flex-col gap-6 md:flex-row md:items-center">
        <div className="relative">
          <div className="absolute -inset-2 rounded-full bg-gradient-to-tr from-cyan-400/40 to-amber-400/40 blur" />
          <img
            src={avatar}
