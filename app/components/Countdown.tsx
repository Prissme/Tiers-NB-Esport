...
export default function Countdown({ targetDate }: CountdownProps) {
  ...
  if (remaining.isLive) {
    return (
      <div className="flex items-center gap-2 rounded-2xl border border-fuchsia-400/30 bg-fuchsia-400/10 px-3 py-2 text-xs text-fuchsia-200">
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-3 py-2 text-xs text-slate-200">
      <span className="text-[10px] uppercase tracking-[0.35em] text-fuchsia-300/80">
        Début LFN
      </span>
