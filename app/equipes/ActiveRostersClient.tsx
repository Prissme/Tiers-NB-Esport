    ...
    <div className="space-y-6">
      ...
      {filteredRosters.length === 0 ? (
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          {filteredRosters.map((team, index) => {
            ...
            const slotSet = new Set(members.map((member) => member.slot).filter(Boolean));
            ...
            return (
              <article
                key={`${team.tag ?? team.name ?? "team"}-${index}`}
              ...
              >
                  ...
                  <div className="flex-1 space-y-2">
                    <div className="flex flex-wrap items-center gap-3">
                      <div>
                        ...
                        <h3 className="text-xl font-semibold text-white">{teamTag}</h3>
                ...
                {membersSorted.length > 0 ? (
                  <div className="relative z-10 mt-6 rounded-2xl border border-white/10 bg-white/5">
                  ...
                  <p className="relative z-10 mt-4 text-sm text-slate-400">
