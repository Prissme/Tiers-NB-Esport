...
const PL_QUEUE_CHANNEL_ID = process.env.PL_QUEUE_CHANNEL_ID || '1442580781527732334';
...
const PRISSCUP_ANNOUNCE_CHANNEL_ID = process.env.PRISSCUP_ANNOUNCE_CHANNEL_ID || '1440767483438170264';
const PRISSCUP_EVENT_URL = 'https://discord.gg/aeqGMNvTm?event=1442798624588435517';
const PRISSCUP_EVENT_NAME = 'PrissCup 3v3';
const RANK_UP_CHANNEL_ID = process.env.RANK_UP_CHANNEL_ID || '1236724293631611022';
...
const SECONDARY_PL_ADMIN_ROLE_ID = process.env.SECONDARY_PL_ADMIN_ROLE_ID || '1472652444331671593';
const PL_PLAYER_ROLE_ID = process.env.PL_PLAYER_ROLE_ID || '1469030334510137398';
const PL_ROLE_CHANNEL_ID = process.env.PL_ROLE_CHANNEL_ID || '1267617798658457732';
